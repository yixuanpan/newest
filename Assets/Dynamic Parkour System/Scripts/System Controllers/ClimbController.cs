...
namespace Climbing
{
    public class ClimbController : MonoBehaviour
    {
        ...
        private bool hasLeftFootIKTarget = false;
        private bool hasRightFootIKTarget = false;
        ...
        public void onAnimatorIK(int layerIndex)
        {
            ...
            {
                characterAnimation.animator.SetIKPositionWeight(AvatarIKGoal.LeftFoot, hasLeftFootIKTarget ? 1 : 0);
                if (hasLeftFootIKTarget)
                    CalculateIKPositions(AvatarIKGoal.LeftFoot, ref leftFootPosition);

                characterAnimation.animator.SetIKPositionWeight(AvatarIKGoal.RightFoot, hasRightFootIKTarget ? 1 : 0);
                if (hasRightFootIKTarget)
        ...
        void IKSolver()
        {
            ...
            hasLeftFootIKTarget = false;
            hasRightFootIKTarget = false;
